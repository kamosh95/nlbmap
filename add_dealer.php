    ...
    try {
        ...
        if (isset($_POST['locations']) && is_array($_POST['locations'])) {
            ...
            foreach ($_POST['locations'] as $loc) {
                if (!empty($loc)) {
                    $loc_stmt->execute([$dealer_id, $loc]);
                }
            }
        }
...
<body>
            ...
            <div class="nav-brand">
                ...
                <div>
                    ...
                    <p style="color: var(--text-muted); font-size: 0.75rem; margin: 0; opacity: 0.8;">
                        Register a new Dealer Profile &nbsp;·&nbsp; Logged in as <span class="role-badge badge-<?php echo $_SESSION['role']; ?>" style="padding: 2px 8px; font-size: 0.65rem;"><?php echo $_SESSION['username']; ?></span>
                    </p>
                </div>
            </div>
                ...
                <form method="POST" enctype="multipart/form-data" id="dealerForm">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
                        <div class="form-group">
                            ...
                            <input type="text" name="dealer_code" id="dealer_code" required oninput="updatePreview()">
                        </div>
                        <div class="form-group">
                    ...
                    <button type="submit" class="btn-submit">Save Dealer Details</button>
                </form>
            </div>
            ...
            <div class="info-panel">
                <div class="info-card" id="previewPanel">
                    ...
                    <div id="pdf-content">
                        <div style="text-align: center; margin-bottom: 15px;">
                            ...
                            <div style="font-weight: 700; font-size: 1.1rem; color: var(--secondary-color);">Dealer Registration</div>
                        </div>
                ...
                <div class="info-card">
                    ...
                    <ul class="tip-list">
                        ...
                        <li>✅ Birthday is auto-extracted from NIC.</li>
                        <li>✅ Add multiple locations for larger businesses.</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function updatePreview() {
            document.getElementById('p_code').innerText = document.getElementById('dealer_code').value || '-';
        ...
        function downloadPDF() {
            ...
            const opt = {
                margin: 0.5,
                filename: 'dealer_' + (document.getElementById('dealer_code').value || 'profile') + '.pdf',
        ...
        function shareWhatsApp() {
            const code = document.getElementById('dealer_code').value;
            const name = document.getElementById('name').value;
            const phone = document.getElementById('phone').value;
            const nic = document.getElementById('nic_new_display').value;
            
            const text = `*New Dealer Registration*\n\n` +
                         `*Code:* ${code}\n` +
                         `*Name:* ${name}\n` +
                         `*NIC:* ${nic}\n` +
                         `*Phone:* +94 ${phone}\n\n` +
